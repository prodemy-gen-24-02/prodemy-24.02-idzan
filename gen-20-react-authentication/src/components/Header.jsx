              ...
              {token ? (
                <li>
                  <button
                    ...
                    className="hover:bg-gray-200 py-4 px-6 w-full transition duration-150"
                  >
                    Logout
                  </button>
                </li>
        ...
        <div className="hidden md:flex items-center space-x-4 transition duration-150">
          ...
          {token ? (
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={handleLogout}
                className="text-gray-800 hover:text-cyan-600"
              >
                Logout
              </button>
            </div>
            ...
            <Link
              to="/login"
              className="text-gray-800 hover:text-cyan-600 cursor-pointer"
            >
              Login
            </Link>
          )}
