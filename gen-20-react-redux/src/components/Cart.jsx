...
function Cart() {
  ...
  return (
    <section className="py-8 flex flex-col min-h-screen w-3/4 mx-auto">
                ...
                <div key={item.id} className="border rounded-lg p-4">
                  <div className="flex flex-col sm:flex-row items-center justify-between">
                    <img
                      src={item.images[0]}
                      alt={item.name}
                      className="w-16 h-16 rounded mb-4 sm:mb-0 sm:mr-4"
                    />
            ...
            <>
              <div className="mt-8">
                ...
                <div className="flex justify-between mb-4">
                  ...
                  <span className="text-md md:text-lg">Rp 20.000,00</span>
                </div>
              ...
              <div className="mt-8">
                <button className="bg-cyan-500 text-white py-3 px-6 rounded-lg hover:bg-cyan-600 w-full sm:w-auto">
                  Continue to Payment
                </button>
              </div>
            </>
