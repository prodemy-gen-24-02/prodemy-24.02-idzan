...
const ProductSection = ({ product }) => {
  ...
  //quantity masih blm bisa di deteksi
        ...
        <div className="h-full flex flex-col justify-between">
          ...
          <div className="flex flex-wrap justify-center ">
            <button
              ...
              className="flex-1 min-w-48 text-nowrap mt-2 mr-4 outline hover:bg-cyan-500 hover:text-white text-cyan-500 font-bold py-2 px-4 rounded shadow-md transition duration-150 ease-out hover:ease-in text-sm md:text-base"
            >
              Tambah ke Keranjang
            </button>
